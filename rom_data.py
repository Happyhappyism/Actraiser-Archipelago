...
music_pointers = [
            bytes([0x9F, 0x76, 0x07]), # Pyramid
            bytes([0x5C, 0xB0, 0x0B]), # Ending
            bytes([0x27, 0xC0, 0x0B]), # All Over the World
            bytes([0x7F, 0x14, 0x0C]), # Fillmore
            bytes([0xFA, 0x54, 0x0C]), # Satan
            bytes([0xCC, 0x5D, 0x0C]), # Bloodpool ~ Kasandora
            bytes([0x4B, 0xFA, 0x0C]), # Northwall
            bytes([0xB8, 0x14, 0x0D]), # Opening
            bytes([0xE2, 0x69, 0x0D]), # The Beast Appears
            bytes([0x63, 0x6F, 0x0D]), # Sacrifices
            bytes([0x70, 0x94, 0x0D]), # Powerful Enemy
            bytes([0xAB, 0xA2, 0x0D]), # Peaceful World
            #bytes([0x6B, 0xFD, 0x0D]), # ???
            bytes([0x88, 0x29, 0x0E]), # Sky Palace 
            #bytes([0xF2, 0x33, 0x0E]), # ???
        ]
custom_lair_images = {
...
obj_tbl_offsets = {
            ...
            # Forest
            0x531F4:[[0x02, 0x03, 0x09, 0x1B],[1,1,1,1], 
                    [0x6,0x7,0x8,0x8,0x2,0x2,0x2,0x2,0x9,0x9,0x1B,0x1B,0x1B,0x1B,0x1B,0x1B,0x1B,0x1B,0x0,0x1,0x3,0x3,0x3,0x80,0x80,0x80]], # Forest Sec 1
            0x53261:[[0x02, 0x03, 0x09, 0x1B],[1,1,1,1],
                    [0x7,0x2,0x2,0x5,0x1C,0x1D,0x1E,0x5,0x1C,0x1D,0x1E,0x4,0x3,0x3,0x3,0x80,0x80]], # Forest Sec 2

            # Chasm
            0x53313:[[0x0E, 0x0F, 0x14, 0x15, 0x16],[1,1,1,1,1],
                     [0x15,0x15,0x15,0x15,0x15,0x15,0x15,0x15,0x15,0x15,0x15,0x15,0x0F,0x0F,0x0F,0x0E,0x0E,0x0E,0x16,0x16,0x16,0x16,0x16,0x16,
                      0x14,0x14,0x14,0x14,0x14,0x14,0x14,0x18,0x18,0x18,0x18,0x13,0x1A,0x80,0x80,0x80,0x80]], # Chasm Room 1
            0x533C0:[[0x0E, 0x0F, 0x14, 0x15, 0x16],[1,1,1,1,1],
                     [0x15,0x15,0x15,0x15,0x15,0x0E,0x0E,0x0E,0x16,0x16,0x10,0x12,0x13,0x1A,0x80,0x80,0x80,]
                    ], # Chasm Room 1 Low
            0x5342F:[[0x0E, 0x0F, 0x14, 0x15, 0x16, 0x17],[1,1,1,1,1,1],
                     [0x19,0x19,0x19,0x19,0x19,0x19,0x19,0x19,0x19,0x19,0x19,0x19,0x0E,0x0E,0x0E,0x15,0x15,0x15,0x16,0x16,0x16,0x14,0x14,0x14,0x14,0x14,0x14,0x17,0x17,0x17,0x17,0x17,0x17,0x80,]
                    ], # Chasm Room 2

            0x534CF:[[0x02,0x03,0x04,0x05],[1,0,0,0],
                     [0x3,0x3,0x3,0x3,0x3,0x4,0x4,0x2,0x2,0x5,0x5,0x5,0x5,0x80,0x80,0x0,0x0,0x1,0x1,0x1,]
                    ], # Bridge Sec 1; Rock Throwers cause the game to crash
            0x53524:[[0x02,0x03,0x04,0x05],[1,0,0,0],
                     [0x3,0x3,0x3,0x3,0x4,0x2,0x2,0x2,0x2,0x2,0x2,0x5,0x5,0x5,0x6,0x80,0x80,0x0,0x1,0x1,0x1,0x1,0x1,0x1,0x1,0x1,0x1,]
                    ], # Bridge Sec 2

            0x5359D:[[0x1E, 0x1F, 0x20, 0x21, 0x22, 0x23, 0x24, 0x25, 0x26],[1,1,1,1,1,1,1,1,1],[0x20,0x20,0x20,0x20,0x26,]], # Castle
            0x535D2:[[0x1E, 0x1F, 0x20, 0x21, 0x22, 0x23, 0x24, 0x26],[1,1,1,1,1,1,1,1],
                     [0x0F,0x0F,0x0F,0x0F,0x0F,0x10,0x10,0x10,0x10,0x13,0x13,0x13,0x13,0x14,0x14,0x14,0x14,0x12,0x12,0x12,0x20,0x20,0x20,0x1F,0x24,0x1F,0x22,0x22,0x22,0x22,0x80,]
                    ], # Castle
            0x5366B:[[0x1E, 0x1F, 0x20, 0x21, 0x22, 0x23, 0x24, 0x25, 0x26],[1,1,1,1,1,1,1,1,1],[0x20,0x20,0x20,0x80,0x26,]], # Castle
            0x536AC:[[0x1E, 0x1F, 0x20, 0x21, 0x22, 0x23, 0x24, 0x25, 0x26],[1,1,1,1,1,1,1,1,1],[0x1F,0x24,0x24,0x1E,0x1E,0x26,0x26,0x11,0x11,0x11,0x11,0x12,0x12,0x12,]], # Castle
            0x536ED:[[0x1E, 0x1F, 0x20, 0x21, 0x22, 0x23, 0x24, 0x25, 0x26],[1,1,1,1,1,1,1,1,1],
                     [0x0F,0x0F,0x0F,0x0F,0x0F,0x10,0x10,0x10,0x10,0x10,0x13,0x13,0x13,0x13,0x14,0x14,0x14,0x14,0x25,0x25,0x23,0x23,0x23,0x22,0x22,0x22,0x1F,0x24,0x1F,0x24,0x80,0x80,]
                    ], # Castle
            0x53776:[[0x1E, 0x1F, 0x20, 0x21, 0x22, 0x23, 0x24, 0x25, 0x26],[1,1,1,1,1,1,1,1,1],[0x26,0x26,0x21,0x21,0x21,0x21,]], # Castle
            0x537A1:[[0x1E, 0x1F, 0x20, 0x21, 0x22, 0x23, 0x24, 0x26],[1,1,1,1,1,1,1,1],
                     [0x23,0x23,0x23,0x23,0x23,0x17,0x16,0x15,0x18,0x17,0x16,0x15,0x18,0x17,0x16,0x15,0x18,0x17,0x16,0x16,0x15,0x26,0x1E,0x80,]
            ], # Castle

            # Desert
            0x5383D:[[0x05, 0x06, 0x07, 0x08, 0x09, 0x0A],[1,1,1,1,1,1],
                     [0x6,0x6,0x6,0x7,0x7,0x7,0x7,0x7,0x7,0x5,0x5,0x5,0x5,0x5,0x5,0x5,0x5,0x5,0x5,0x5,0x5,0x80]
                    ], # Desert 1
            0x5389A:[[0x05, 0x06, 0x07, 0x08, 0x09, 0x0A],[1,1,1,1,1,1],
                     [0x6,0x9,0x9,0x9,0x9,0x9,0x9,0x9,0x9,0x9,0x9,0x9,0x0A,0x0A,0x0A,0x4,0x7,0x5,0x5,0x5,0x5,0x5,0x5,0x8,0x8,0x8,0x80,0x80,0x80,0x80]
                    ], # Desert 2

            0x5391B:[[0x0C, 0x0D, 0x0E, 0x0F, 0x10, 0x11],[1,1,1,1,1,1],
                     [0xC,0xC,0xC,0xC,0xC,0xC,0xD,0xD,0xD,0xE,0xF,0xF,0xF,0x10]
                    ], # Pryamid 1
            0x53966:[[0x13, 0x14, 0x15, 0x16],[1,1,1,1],
                     [0x18,0x18,0x19,0x19,0x1A,0x1A,0x1A,0x1A,0x1A,0x1B,0x1B,0x1B,0x13,0x14,0x14,0x14,0x15,0x15,0x15,0x15,0x15,0x15,0x15,0x15,0x15,0x16,0x16,0x16,0x16,0x16,0x16,0x80,0x80,0x80]
                    ], # Pryamid 2
            0x53A01:[[0x0C, 0x0D, 0x0E, 0x0F, 0x10, 0x11],[1,1,1,1,1,1],
                     [0x17,0xC,0xC,0xC,0xC,0xC,0xD,0xD,0xD,0xD,0xD,0xD,0xD,0xD,0xD,0xD,0xE,0xE,0xE,0xF,0xF,0xF,0x10,0x10,0x10,0x11,0x12,0x12,0x12,0x12,0x12,0x12,0x80]
                    ], # Pryamid 3

            0x53AB1:[[0x03, 0x04, 0x07,0x09, 0x0A, 0x0B, 0x0C],[0,0,1,0,0,1,1],
                     [0x1D,0x1E,0x6,0x6,0x3,0x3,0x3,0x3,0x3,0x3,0x4,0x4,0x7,0x7,0x7,0x7,0x7,0xB,0x5,0x5,0x5,0x5,0x5,0x5,0xC,0xC,0xC,0xC,0xC,0x80]
                    ], # Mountain 1
            0x53B2E:[[0x03, 0x04, 0x07,0x09, 0x0A, 0x0B, 0x0C],[0,0,1,0,0,1,1],
                     [0x3,0x3,0x3,0x3,0x8,0x8,0x8,0x8,0x8,0x8,0x1C,0x1C,0x9,0x9,0x9,0xA,0xA,0xB,0x80,0x80]
                    ], # Mountain 2
            0x53B87:[[0x03, 0x04, 0x07,0x09, 0x0A, 0x0B, 0x0C],[0,0,1,0,0,1,1],
                     [0xB,0xB,0x3,0x3,0x3,0x3,0x3,0x3,0x4,0x4,0x80,0x80,0x80]
                     ], # Mountain 3

            0x53BE3:[[0x11, 0x12, 0x13, 0x14, 0x15],[1,1,1,1,1],
                     [0x11,0x11,0x12,0x12,0x12,0x12,0x12,0x13,0x13,0x13,0x13,0x15,0x15,0x15,0x15,0x15,0x15]
                    ], # Volcano 1
            0x53C39:[[0x11, 0x12, 0x13, 0x14, 0x15],[1,1,1,1,1],
                     [0x13,0x19,0x19,0x19,0x19,0x19,0x19,0x19]], # Volcano 2
            0x53C67:[[0x11, 0x12, 0x13, 0x14, 0x15],[1,1,1,1,1],
                     [0x11,0x11,0x11,0x12,0x13,0x13,0x13,0x14,0x14,0x14,0x14,0x15,0x15,0x15,0x15,0x15,0x16,0x16,0x17,0x17,0x17,0x18,0x18,0x18,0x18,0x18,0x80,0x80]
                    ], # Volcano 3

            0x53CEB:[[0x06,0x07,0x08,0x09,0x0A,0x0B,0x0C],[1,1,1,1,1,1,1],
                     [0x6,0x6,0x6,0x7,0x7,0x7,0x8,0x8,0x8,0x9,0x9,0x9,0x9,0x9,0xB,0xC,0xC,0xC,0xC,0xC,0xC,0x80,0x80]
                    ], # Swamp 1
            0x53D50:[[0x06,0x07,0x08,0x09,0x0A,0x0B,0x0C],[1,1,1,1,1,1,1],
                     [0x6,0x6,0x6,0x7,0x8,0x8,0x9,0xA,0xA,0xA,0xA,0xA,0xB,0xB,0xC,0xC,0x80,0x80]
                    ], # Swamp 2

            0x53DAC:[[0x0D, 0x0E, 0x10, 0x12, 0x13, 0x14, 0x20],[1,1,1,1,1,0,1],
                    [0x21,0xD,0xD,0xE,0xE,0xE,0xE,0xE,0xF,0xF,0xF,0xF,0x10,0x11,0x11,0x11]
                    ], # Temple
            0x53DFE:[[0x0D, 0x0E, 0x10, 0x12, 0x13, 0x14, 0x20],[1,1,1,1,1,0,1],
                     [0xD,0xD,0xE,0x18,0x18,0x18,0x80] ], # Temple
            0x53E46:[[0x0D, 0x0E, 0x10, 0x12, 0x13, 0x14, 0x20],[1,1,1,1,1,0,1],
                    [0xE,0xE,0xE,0xE,0x12,0x12,0x20,0x20,0x20] ], # Temple
            0x53E6F:[[0x0D, 0x0E, 0x10, 0x12, 0x13, 0x14, 0x20],[1,1,1,1,1,0,1],
                     [0xD,0xD,0xE,0xE,0xE,0xE,0xE,0xE,0xF,0xF,0x10,0x10,0x11,0x11,0x12,0x12,0x12,0x19,0x1A,0x1B,0x1C,0x1D,0x1F,0x13,0x14,0x13,0x14,0x13,0x14,0x13,0x14,0x13,0x14,0x80,0x80]
                    ], # Temple
            0x53F27:[[0x0D, 0x0E, 0x10, 0x12, 0x13, 0x14, 0x20],[1,1,1,1,1,0,1],
                     [0xE,0x10,0x10,0x10,0x12,0x12,0x15,0x15,0x15,0x15,0x16,0x16,0x17,0x17]
                    ], # Temple
            0x53F64:[[0x0D, 0x0E, 0x10, 0x12, 0x13, 0x14, 0x20],[1,1,1,1,1,0,1],
                     [0xD,0xD,0xE,0xE,0xE,0xE,0xE,0xE,0xE,0xF,0xF,0x10,0x10,0x11,0x11,0x12,0x12,0x12,0x19,0x1A,0x1B,0x1C,0x1E,0x1F,0x13,0x14,0x13,0x14,0x13,0x14,0x80,0x80]
                    ], # Temple

            0x54047:[[0x09,0x0A,0x0B, 0x0C, 0x0D, 0x0E ],[1,1,1,1,1,1],
                     [0x9,0xA,0xA,0xA,0xA,0xA,0xA,0xA,0xA,0xA,0xB,0xB,0xB,0xB,0xB,0x11,0x11,0x11,0x11,0x11,0x11,0x11,0x11,0x11,0x11,0x80]
                    ], # Cave 1
            0x540DB:[[0x09,0x0A,0x0B, 0x0C, 0x0D, 0x0E ],[1,1,1,1,1,1],
                     [0x9,0x9,0xB,0xB,0xC,0xD,0xD,0xD,0xD,0xD,0xE,0xE,0xE,0xF,0xF,0x15,0x11,0x11,0x11,0x11,0x11,0x11,0x11,0x11,0x11,0x11,0x14,0x14,0x14,0x80,0x80,0x80]
                    ], # Cave 2
            0x54188:[[0x09,0x0A,0x0B, 0x0C, 0x0D, 0x0E ],[1,1,1,1,1,1],
                     [0x9,0xC,0xD,0xD,0xD,0xE,0xE,0xE,0xE,0xE,0xE,0xE,0x10,0x14,0x14,0x14,0x80,0x80,0x80,0x80]
                    ], # Cave 3
            0x541E1:[[0x09,0x0A,0x0B, 0x0C, 0x0D, 0x0E ],[1,1,1,1,1,1],
                    [0x9,0x9,0x9,0x9,0x9,0xB,0xB,0xB,0xB,0xC,0xC,0xD,0xD,0xD,0xD,0xE,0xE,0xE,0x80,0x80]
                    ], # Cave 4


            0x5424E:[[0x09, 0x0E, 0x16, 0x19, 0x1A, 0x1B, 0x1C, ],[1,1,1,1,1,1,1],
                     [0xE,0xE,0xE,0xE,0x9,0x9,0x80,0x80,0x80,0x80]], #Tree 1
            0x542B6:[[0x09, 0x0E, 0x16, 0x19, 0x1A, 0x1B, 0x1C, ],[1,1,1,1,1,1,1],
                     [0xE,0xE,0xE,0xE,0xE,0xE,0xE,0xE,0x16,0x16,0x16,0x16,0x16,0x9,0x9,0x9,0x9,0x9,0x9,0x9,0x9,0x9,0x9,0x1A,0x1A,0x1A,0x1B,0x1B,0x1B,0x1B,0x1B,0x1C,0x1C,0x1C,0x1C,0x1C,0x1C,0x1C,0x1C,0x1C,0x1C,0x80,0x80,0x80,0x80,0x80,0x80]
                    ], #Tree 2
            0x5439E:[[0x09, 0x0E, 0x16, 0x19, 0x1A, 0x1B, 0x1C, ],[1,1,1,1,1,1,1],
                     [0x9,0x9,0x16,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x17,0x17,0x17,0x19,0x19,0x1A,0x1A,0x1B,0x1B,0x1B,0x1C,0x1C,0x1C,0x1C,0x1C,0x80]
                    ], #Tree 3
        }
