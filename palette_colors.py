colorsets = [
        ...
        {
            #[1] Single Color
           "Yellow": [[0xDC, 0x02]], # Yellow
           "Cyan": [[0x33, 0x7F]], # 
           "Gold": [[0xDF, 0x22]], # Gold
           "Pink": [[0x5F, 0x42]], # Pink
           "Green": [[0x44, 0x02]], # Green
           "Purple": [[0xCC, 0x48]], # Purple
           "Blue": [[0xA5, 0x6D]], # Blue
           "Grey": [[0xCE, 0x39]], # Grey
           "Deep Blue": [[0x84, 0x50]], # Deep Blue
           "Traffic Orange": [[0x1E, 0x11]], # Traffic Orange
           "Sand Yellow": [[0x98, 0x32]], # Sand Yellow
           "Flame Red": [[0xB5, 0x0C]], # Flame Red
           "Capri Blue": [[0x43, 0x41]], # Capri Blue
           "Pearl Green": [[0x43, 0x15]], # Pearl Green
           "Beige": [[0xD8, 0x3E]], # Beige
           "Telemagenta": [[0xD9, 0x38]], # Telemagenta
           "Copper brown": [[0x11, 0x15]], # Copper brown
           "Mint": [[0xC7, 0x46]], # Mint
           "Silver": [[0x18, 0x63]], # Silver 
           "Gold": [[0x5A, 0x1A]], # Gold
           "Indigo": [[0x8B, 0x69]], # Indigo
           "Teal": [[0x88, 0x5E]], # Teal
           "Pink": [[0xFD, 0x6E]], # Pink
           "Olive": [[0x10, 0x02]], # Olive
           "Crimson": [[0x5B, 0x1C]], # Crimson
           "Steel Blue": [[0x08, 0x5A]], # Steel Blue
           "Coral": [[0xFF, 0x29]], # Coral
        },
        {
            # [2] 2 Color sets
            "rose red":    [[0x14,0x00],[0x9F,0x10]],
            "gold":        [[0x7F,0x06],[0x7F,0x83]],
            "green":       [[0xAD,0x2A],[0x2F,0x33]],
            "teal":        [[0x61,0x46],[0x08,0x5B]],
            "blue":        [[0xA3,0x55],[0x44,0x72]],
            "fairy":       [[0x75,0x35],[0xBC,0x3D]],
            "pastel":      [[0x78,0x6E],[0x3A,0x7F]],
        ...
        },
        {
            ...
            "shadow":       [[0xC6,0xAC],[0x49,0x39],[0x2E,0x5E]],
            "pink rose":    [[0x37,0x98],[0x1D,0xCD],[0x7F,0x5E]],
            "cream":        [[0x94,0xA5],[0xBC,0xC6],[0x9F,0x5F]],
            "rust":         [[0xF0,0x0C],[0xFB,0x80],[0x3E,0x06]],
            "calico":       [[0x47,0x00],[0xB2,0x25],[0x9D,0x2A]],
            "earthygreen":  [[0x40,0x21],[0x80,0x3A],[0x23,0x4F]],
            "ray gray":     [[0xD2,0x66],[0x56,0x7B],[0xF9,0x7F]],
            "silver":       [[0xCC,0x39],[0xD4,0x56],[0x5A,0x6F]],
            "reptile green":[[0x25,0x0A],[0x09,0x33],[0xEF,0x47]],
        },
        {
            #[7] 4 Color sets
            "sonic blue": [[0x00,0x34], [0x80,0x54], [0x00,0x75], [0x60,0xFE]],
            "tails orange":[[0x34,0x09],[0xFC,0x91],[0xFF,0x12],[0xDF,0x4B]],
            "piggy pink":  [[0x56,0x24],[0xDC,0x3C],[0xDE,0x55],[0xBF,0x6E]],
            "toxic green": [[0x23, 0x25],[0xc4, 0x29],[0xa6, 0x2a],[0x6b, 0x3b]],
            "purple vibe": [[0x88, 0x34], [0x49, 0x4c], [0x91, 0x61], [0x17, 0x7e]],
            "gameboy":     [[0x04, 0x19], [0xa8, 0x15], [0x4d, 0x12], [0xb1, 0x16]],
            "poochyfur":   [[0xC6,0x20],[0x49,0x31],[0xF0,0x45],[0x74,0x56]],
            "magma":       [[0x92,0x00],[0x7B,0x11],[0x1F,0x26],[0xFF,0x36]],
            "stone":       [[0x08,0x21],[0x8C,0x31],[0x10,0x42],[0xB5,0x56]],
            "gold":        [[0xB4,0x01],[0xBC,0x02],[0x9F,0x03],[0xBF,0x43]],
            "fire":        [[0x1D,0x00],[0x9F,0x01],[0x7F,0x02],[0x9F,0x13]],
            "guard shield":[[0x93,0xA4],[0x18,0x45],[0x9D,0x65],[0xFF,0x7E]],
            "choas water": [[0x2B,0xCD],[0x0D,0x72],[0xE0,0x7E],[0xB0,0xFF]],
            "emerald":     [[0x82,0x91],[0x24,0x0A],[0xA7,0x82],[0x93,0x27]],
            "bee yellow":  [[0x51,0x01],[0x9D,0x1A],[0x3F,0x27],[0xDF,0x53]],
            "charorange":  [[0xD2,0x00],[0x5B,0x11],[0x5F,0x22],[0x1F,0x33]],
            "royalpurple": [[0xB1,0x40],[0x97,0x5D],[0x7C,0x6A],[0x5F,0x7F]],
            "fairy":       [[0xF6,0x14],[0xBF,0x2D],[0x7F,0x42],[0x1F,0x53]],
            "gloom":       [[0xC2,0x2C],[0xA9,0x3D],[0x4E,0x52],[0xD2,0x62]],
            "wood":        [[0x90,0x1D],[0xD3,0x25],[0x57,0x2E],[0x3D,0x53]],
            "ice":         [[0x8A,0x4D],[0xCE,0x72],[0x75,0x7F],[0xFA,0x7F]],
        ...
        { #[5] Base 5 Color Set
            ...
            "rouge pink":   [[0xEC, 0xB8], [0xF4, 0x40], [0x3A, 0xE5], [0xDE, 0xD8], [0x9F, 0xF2]],
            "steel":        [[0x4A,0x29],[0xEF,0x41],[0x94,0x56],[0x18,0x67],[0x9C,0x77]],
        },
        {
            #[6] 6 color sets
        ...
        {
            #[7] 7 color sets
            "ocean blue":   [[0x00,0x78],[0xE0,0x74],[0xC0,0x75],[0xC0,0x72],[0x81,0x6F],[0xCA,0x7F],[0xF5,0x7F]],
