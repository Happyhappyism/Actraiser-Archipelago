...
from .Options import ActraiserOptions, actraiser_option_groups
from .Regions import region_data_table, get_exit
from .Rules import *
from .Rom import LocalRom, patch_rom, get_base_rom_path, ActraiserProcedurePatch, USHASH
...
class ActraiserWebWorld(WebWorld):
    ...
    tutorials = [setup_en]
    option_groups = actraiser_option_groups

class ActraiserWorld(World):
    """Actraiser is a unique blend of action-platforming and city-building simulation developed by Quintet.
      The gameplay alternates between side-scrolling action stages, where players combat monsters and bosses, and city-building segments, where they help villagers rebuild their settlements and fend off further threats.
      The apworld focuses more on the city building segments, city regions are gated by a number 'Level Up' items and various city building milestones and action stage orbs are locations."""
